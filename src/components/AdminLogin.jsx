...
export default function AdminLogin({ onSuccess, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center p-4">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-md bg-[#0f0f1e] border border-violet-500/25 rounded-3xl shadow-[0_25px_80px_rgba(124,58,237,0.25)] overflow-hidden"
      ...
      >
        ...
        {/* Header */}
        <div className="px-8 pt-8 pb-6 text-center border-b border-white/6">
          <div className="w-16 h-16 rounded-2xl bg-violet-600/20 border border-violet-500/30 flex items-center justify-center mx-auto mb-4">
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-violet-400">
              <path d="M18 8h-1V6c0-2.76-2.24-5-5-5S7 3.24 7 6v2H6c-1.1 0-2 .9-2 2v10c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V10c0-1.1-.9-2-2-2zm-6 9c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm3.1-9H8.9V6c0-1.71 1.39-3.1 3.1-3.1 1.71 0 3.1 1.39 3.1 3.1v2z"/>
            </svg>
          </div>
          <h2 className="text-white font-extrabold text-xl mb-1">Accès Administrateur</h2>
          <p className="text-white/40 text-sm">Connectez-vous pour accéder au tableau de bord</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-8 py-7 flex flex-col gap-4">
          ...
          <p className="text-center text-white/25 text-xs mt-1">
            Accès réservé aux administrateurs CasaShoes
          </p>
        </form>
