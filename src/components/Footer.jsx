...
const socials = [
  {
    ...
    color: "hover:shadow-[0_0_20px_rgba(240,148,51,0.6)] hover:bg-gradient-to-br hover:from-[#f09433] hover:via-[#e6683c] hover:via-[#dc2743] hover:via-[#cc2366] hover:to-[#bc1888] hover:border-[#bc1888]",
    svg: (
  ...
  },
  {
    ...
    color: "hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] hover:bg-black hover:border-white/50",
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  },
  {
    label: "X (Twitter)",
    href: "https://x.com",
    color: "hover:shadow-[0_0_20px_rgba(255,255,255,0.3)] hover:bg-black hover:border-white/50",
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
  ...
  },
  {
    ...
    color: "hover:shadow-[0_0_20px_rgba(37,211,102,0.6)] hover:bg-[#25d366] hover:border-[#25d366]",
    svg: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
            ...
            <div className="flex gap-2.5">
              {socials.map((s) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className={`w-11 h-11 flex items-center justify-center rounded-full bg-white/8 border border-white/15 text-white no-underline hover:-translate-y-1.5 transition-all duration-300 hover:scale-110 ${s.color}`}
                >
                  {s.svg}
                </a>
              ))}
              ...
              {navLinks.map((l) => (
                <li key={l.label}>
                  <a
                    ...
                    className="text-white/50 text-sm no-underline hover:text-violet-400 transition-all"
                  >
                    {l.label}
                  </a>
                </li>
              ...
              {categories.map((l) => (
                <li key={l.label}>
                  <button
                    ...
                    className="text-white/50 text-sm no-underline bg-transparent border-none p-0 cursor-pointer hover:text-violet-400 transition-all"
                  >
                    {l.label}
                  </button>
                </li>
            ...
            <ul className="list-none p-0 m-0 flex flex-col gap-3.5">
              {infos.map((item) => (
                <li key={item.text} className="flex items-center gap-3">
                  <span className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 border border-white/10 transition-all duration-300 hover:-translate-y-0.5 hover:border-white/30 hover:scale-105 ${item.color}`}>
                    {item.svg}
                  </span>
                  {item.href ? (
